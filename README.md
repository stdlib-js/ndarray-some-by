...
```javascript
import someBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-some-by@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-some-by@v0.1.1-esm/index.mjs';
```
